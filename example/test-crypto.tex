...
% Utiliser le package TrustNoCorpo dédié
\usepackage{tnc}
...
% Démonstration des macros (facultatif, la CLI peut injecter ses propres réglages)
...
% \tncrecipient{alice-token-123} % Dé-commentez pour un jeton destinataire
